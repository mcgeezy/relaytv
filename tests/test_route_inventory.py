...
EXPECTED_ROUTES = {
    ...
    ("POST", "/integrations/plex/auth/cancel", "plex_auth_cancel"),
    ("POST", "/integrations/plex/auth/poll", "plex_auth_poll"),
    ("POST", "/integrations/plex/auth/start", "plex_auth_start"),
    ("POST", "/integrations/plex/disconnect", "plex_disconnect"),
    ("POST", "/integrations/plex/server", "plex_server_select"),
    ("GET", "/integrations/plex/status", "plex_integration_status"),
    ("POST", "/integrations/plex/test", "plex_integration_test"),
    ("GET", "/integrations/seerr/status", "seerr_integration_status"),
    ("GET", "/integrations/seerr/session", "seerr_caller_session_status"),
    ("POST", "/integrations/seerr/session/logout", "seerr_caller_session_logout"),
    ("POST", "/integrations/seerr/session/quick-connect", "seerr_quick_connect_start"),
    ("POST", "/integrations/seerr/session/quick-connect/complete", "seerr_quick_connect_complete"),
    ("POST", "/integrations/seerr/test", "seerr_integration_test"),
    ("GET", "/integrations/seerr/users", "seerr_integration_users"),
    ...
    ("POST", "/peers/{peer_id}/handoff", "peers_handoff"),
    ...
    ("GET", "/plex/artwork/{asset_id}", "plex_artwork"),
    ("GET", "/plex/home", "plex_home"),
    ("POST", "/plex/items/action", "plex_item_action"),
    ("GET", "/plex/items/{item_id}", "plex_item_detail"),
    ("GET", "/plex/items/{item_id}/children", "plex_item_children"),
    ("GET", "/plex/libraries", "plex_libraries"),
    ("GET", "/plex/libraries/{library_id}/items", "plex_library_items"),
    ("GET", "/plex/search", "plex_search"),
    ("GET", "/plex/servers", "plex_servers"),
    ("GET", "/plex/stream/{stream_id}", "plex_stream"),
